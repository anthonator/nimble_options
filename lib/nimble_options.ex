defmodule NimbleOptions do
  ...
  defp validate_type(:integer = type, key, value, redact) when not is_integer(value) do
    structured_error_tuple(key, value, type, "integer", redact)
  end
  ...
  defp structured_error_tuple(key, value, type, expected, got, redact?) do
    message =
      if redact? do
    ...
    {:error,
     %ValidationError{key: key, message: message, type: type, redact: redact?, value: value}}
  end
